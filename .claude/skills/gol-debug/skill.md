...
```bash
# 治疗玩家
node gol-tools/screenshot/ai-debug.mjs console heal full

# 传送到指定位置
node gol-tools/screenshot/ai-debug.mjs console tp 100 200

# 设置时间
node gol-tools/screenshot/ai-debug.mjs console time 12
node gol-tools/screenshot/ai-debug.mjs console day
node gol-tools/screenshot/ai-debug.mjs console night

# 无敌模式
node gol-tools/screenshot/ai-debug.mjs console god

# 列出实体
node gol-tools/screenshot/ai-debug.mjs console list enemy

# 杀死实体
node gol-tools/screenshot/ai-debug.mjs console kill enemy
```
...
```bash
# 获取玩家位置
node gol-tools/screenshot/ai-debug.mjs get player.pos

# 获取玩家血量
node gol-tools/screenshot/ai-debug.mjs get player.hp

# 获取当前时间
node gol-tools/screenshot/ai-debug.mjs get time

# 获取实体数量
node gol-tools/screenshot/ai-debug.mjs get entity_count
```
...
```bash
# 设置时间为午夜
node gol-tools/screenshot/ai-debug.mjs set time 0

# 设置为正午
node gol-tools/screenshot/ai-debug.mjs set time 12
```
...
```bash
# 简单计算
node gol-tools/screenshot/ai-debug.mjs eval "1 + 1"
...
```bash
node gol-tools/screenshot/ai-debug.mjs script test_enemy_count.gd
```
